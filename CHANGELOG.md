...
## [Unreleased][]
### Added
- Syntax: added special Library-Tree-SMP syntax docs which can be opened via 'search menu\Help\Library-Tree-SMP syntax'. These docs show all special functions using on views, filter, search box and sorting.
