...
class Panel {
	...
	getFilters() {
		let pt = [
			...
			['Filter 07: Name // Query', 'Played Often // ("$max(%PLAY_COUNT%,%LASTFM_PLAY_COUNT%,%2003_PLAYCOUNT%,0)" GREATER 3) AND ((%LAST_PLAYED_ENHANCED% PRESENT AND %LAST_PLAYED_ENHANCED% DURING LAST 50 WEEKS) OR (%2003_LAST_PLAYED% PRESENT AND %2003_LAST_PLAYED% DURING LAST 50 WEEKS) OR (%2003_LAST_PLAYED% MISSING AND %LAST_PLAYED% DURING LAST 50 WEEKS)) AND ("$puts(val,$puts(pcr,$div($mul($max(%PLAY_COUNT%,%LASTFM_PLAY_COUNT%,%2003_PLAYCOUNT%,0),100000),$add($mul($sub($year($if3(%LAST_PLAYED_ENHANCED%,%2003_LAST_PLAYED%,%LAST_PLAYED%,0)),$year($if3(%ADDED_ENHANCED%,%ADDED%,%2003_ADDED%))),365),$mul($sub($month($if3(%LAST_PLAYED_ENHANCED%,%2003_LAST_PLAYED%,%LAST_PLAYED%,0)),$month($if3(%ADDED_ENHANCED%,%ADDED%,%2003_ADDED%))),30),$sub($day_of_month($if3(%LAST_PLAYED_ENHANCED%,%2003_LAST_PLAYED%,%LAST_PLAYED%,0)),$day_of_month($if3(%ADDED_ENHANCED%,%ADDED%,%2003_ADDED%))))))$left($ifgreater($mod($get(pcr),100000),0,$ifgreater($get(pcr),100000,,0)$insert($div($get(pcr),10000),\'.\',$sub($len($div($get(pcr),10000)),1))$ifgreater($mod($get(pcr),10000),0,$insert($div($get(pcr),1000),,$sub($len($div($get(pcr),1000)),1)),0),$div($get(pcr),100000)),4))$get(val)$iflonger($get(val),1,,.00)" GREATER 0)'],
			['Filter 08: Name // Query', 'Recently Added // (%ADDED_ENHANCED% PRESENT AND %ADDED_ENHANCED% DURING LAST 4 WEEKS) OR (%2003_ADDED% PRESENT AND %2003_ADDED% DURING LAST 4 WEEKS) OR (%2003_ADDED% MISSING AND %ADDED% DURING LAST 4 WEEKS)'],
			['Filter 09: Name // Query', 'Recently Played // (%FIRST_PLAYED_ENHANCED% PRESENT AND %FIRST_PLAYED_ENHANCED% DURING LAST 4 WEEKS) OR (%2003_FIRST_PLAYED% PRESENT AND %2003_FIRST_PLAYED% DURING LAST 4 WEEKS) OR (%2003_FIRST_PLAYED% MISSING AND %FIRST_PLAYED% DURING LAST 4 WEEKS)'],
			['Filter 10: Name // Query', 'Top Rated // %RATING% EQUAL 5 OR %2003_RATING% EQUAL 10'],
			['Filter 11: Name // Query', 'separator // .'],
			['Filter 12: Name // Query', 'Selected Artist // ARTIST IS $selected{$if2($meta(ARTIST,0),DUMMY)} OR ARTIST IS $selected{$if2($meta(ARTIST,1),DUMMY)} OR ARTIST IS $selected{$if2($meta(ARTIST,2),DUMMY)} OR ARTIST IS $selected{$if2($meta(ARTIST,3),DUMMY)} OR ARTIST IS $selected{$if2($meta(ARTIST,4),DUMMY)} OR ARTIST IS $selected{$if2($meta(ARTIST,5),DUMMY)}'],
			['Filter 13: Name // Query', 'separator // .'],
			['Filter 14: Name // Query', 'Nowplaying Artist // ARTIST IS $nowplaying{$if2($meta(ARTIST,0),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(ARTIST,1),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(ARTIST,2),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(ARTIST,3),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(ARTIST,4),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(ARTIST,5),DUMMY)}'],
			['Filter 15: Name // Query', 'Nowplaying Genre // (GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,0)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,1)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,2)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,3)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,4)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,5)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)}) AND NOT ARTIST IS $nowplaying{$if2($meta(ARTIST,0),DUMMY)}'],
			['Filter 16: Name // Query', 'Nowplaying Style // (STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,0)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,1)),female vocal,,live,,hi-fi,,instrumental,)),DUMMY)} OR STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,2)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,3)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,4)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,5)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)}) AND NOT ARTIST IS $nowplaying{$if2($meta(ARTIST,0),DUMMY)}'],
			['Filter 17: Name // Query', 'Nowplaying Decade // "$replace($sub($year(%DATE%),$nowplaying{$year(%DATE%)}),-,)" LESS 10'],
			['Filter 18: Name // Query', 'separator // .'],
			['Filter 19: Name // Query', 'Nowplaying Similar Artists // ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS LISTENBRAINZ,0),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS LISTENBRAINZ,1),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS LISTENBRAINZ,2),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS LISTENBRAINZ,3),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS LISTENBRAINZ,4),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS LISTENBRAINZ,5),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS LISTENBRAINZ,6),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS LISTENBRAINZ,7),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS LISTENBRAINZ,8),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS LISTENBRAINZ,9),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS SEARCHBYDISTANCE,0),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS SEARCHBYDISTANCE,1),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS SEARCHBYDISTANCE,2),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS SEARCHBYDISTANCE,3),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS SEARCHBYDISTANCE,4),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS SEARCHBYDISTANCE,5),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS SEARCHBYDISTANCE,6),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS SEARCHBYDISTANCE,7),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS SEARCHBYDISTANCE,8),DUMMY)} OR ARTIST IS $nowplaying{$if2($meta(SIMILAR ARTISTS SEARCHBYDISTANCE,9),DUMMY)}'],
			['Filter 20: Name // Query', 'Nowplaying Similar // (GENRE MISSING OR (GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,0)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,1)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,2)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,3)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,4)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR GENRE IS $nowplaying{$if2($replace($lower($meta(GENRE,5)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)})) AND (STYLE MISSING OR (STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,0)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,1)),female vocal,,live,,hi-fi,,instrumental,)),DUMMY)} OR STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,2)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,3)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,4)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)} OR STYLE IS $nowplaying{$if2($replace($lower($meta(STYLE,5)),female vocal,,live,,hi-fi,,instrumental,),DUMMY)})) AND NOT ARTIST IS $nowplaying{$if2($meta(ARTIST,0),DUMMY)} AND "$replace($sub($year(%DATE%),$nowplaying{$year(%DATE%)}),-,)" LESS 10'],
			// Regorxxx ->
		];
