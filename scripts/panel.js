...
class Panel {
	...
	getViews() {
		...
		let pt = [
			...
			['View XX: Name // Pattern', "View by Artist initial // $upper($ascii($cut($replace($swapprefix(%ARTIST%,A,The,La,El,Los,Las,Le,Les),$char(39)$char(39),,$char(39),,),1)))|%ARTIST%|$if2(%ALBUM%$nodisplay{%COMMENT%-%MUSICBRAINZ_ALBUMID%},εXtra)|[[%DISCNUMBER%.]%TRACKNUMBER%. ][%TRACK ARTIST% - ]%TITLE%"],
